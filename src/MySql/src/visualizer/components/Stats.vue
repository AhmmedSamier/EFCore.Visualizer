...
import type { Node, StatsTableItemType } from "@visualizer/interfaces"
import { NodeProp, SortDirection } from "@visualizer/enums"
import SortedTable from "@visualizer/components/SortedTable.vue"
import SortLink from "@visualizer/components/SortLink.vue"
import StatsTableItem from "@visualizer/components/StatsTableItem.vue"
          ...
          <div class="card-body">
            ...
            >
              ...
              <template v-slot:body="sort">
                <template v-for="value in sort.values" :key="(value as any).name">
                  <StatsTableItem
